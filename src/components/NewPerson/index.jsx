    ...
    return <>
        <form className="New-Person-Form">
            <div className="Row">
                ...
                <Select name="sex" onChange={onChangeHanler} value={data.sex}>
            ...
            <div className="Row">
                ...
                <Select name="country" onChange={onChangeHanler} value={data.country}>
                    <option value="">--- Select an Option ---</option>
            ...
            <div className="Row">
                <Button className="append" disabled={!isAllowClick()} onClick={onClickAcceptHandler}><BsFillPersonPlusFill /> Aceptar</Button>
            </div>
        </form>
    </>
}
